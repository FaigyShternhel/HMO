...
and the server side using NODE.JS
I made the database with MONGOBD
To run the project enter the terminal and run the client side and the server side like this:
cd Client
npm i
npm start
and in parallel
